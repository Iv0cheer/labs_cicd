...
> ERP/CRM система. Запустить контейнер (потребует настройки связи с Postgres или просто запуска веб-интерфейса для проверки доступности на порту 8069). Полезно для понимания бизнес-процессов.
...
### Выводы: В результате работы были освоены процессы установки и настройки Docker, а также получены практические навыки управления контейнерами и образами, что позволяет эффективно применять контейнеризацию для изолированного развертывания аналитических сред и сервисов.
